...
<body>
	...
	<form name="update_user" method="post" action="edit.php">
		<table border="0">
			...
			<tr> 
				<td>Mac</td>
				<td><input type="text" name="macAddress" value=<?php echo $macAddress;?>></td>
			</tr>
			<tr> 
				<td>Miner Type</td>
				<td><input type="text" name="minerType" value=<?php echo $minerType;?>></td>
			</tr>
			<tr> 
				<td>Physical Location</td>
				<td><input type="text" name="plocation" value=<?php echo $plocation;?>></td>
			</tr>
			<tr> 
				<td>Hashrate</td>
			...
			<tr> 
				<td>Farm Name</td>
				<td><input type="text" name="farmName" value=<?php echo $farmName;?>></td>
			</tr>
			<tr> 
				<td>Hash Boards</td>
